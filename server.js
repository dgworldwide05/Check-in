...
app.listen(PORT, () => {
  ...
  // In-app daily scheduler — runs at BIRTHDAY_EMAIL_TIME (24h "HH:mm", default "06:00"),
  // server timezone set via BIRTHDAY_TZ (default Africa/Accra).
  const [hh, mm] = (process.env.BIRTHDAY_EMAIL_TIME || '06:00').split(':');
